...
class EarlyStopper:
    def __init__(self, max_patience=2):
...
def main():
    ...
    # early_stopper = EarlyStopper(), define and potentially retrain later 
    ...
    user_choosing = True
    while user_choosing:
        wish_to_save = input("Do you wish to save the model? (Y/N)")
